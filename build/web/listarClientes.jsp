                            ...
                            <table class="table table-hover table bordered responsive" 
                                ...
                                <c:forEach items="${cliente}" var="cl">
                                    <tr>
                                        ...
                                        <td>${cl.telefone}</td>
                                        <td>
                                            <fmt:formatDate pattern = "dd/MM/yyyy" value = "${cl.dataCadastro}" />
                                        </td>
                                        <td>
                                            <c:choose>
                                        ...
                                        <td>
                                            ...
                                            <a href="gerenciarCliente?acao=alterar&idCliente=${cl.idCliente}"
                                            ...
                                            <c:choose>
                                                <c:when test="${cl.status == 1}">
                                                    <button class="btn btn-danger btn-sm"
                                                        onclick="confirmDesativar('${cl.idCliente}','${cl.nome}')">
                                                        Desativar&nbsp;
                                                ...
                                                <c:otherwise>
                                                    <button class="btn btn-success btn-sm"
                                                        onclick="confirmAtivar('${cl.idCliente}', '${cl.nome}')">
                                                        Ativar&nbsp;
